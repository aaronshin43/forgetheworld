...
export const SKILL_CONFIGS: Record<string, SkillConfig> = {
    // Ultimate Defaults
    "astralblitz": { x: 50, y: 55, scale: 1.3 },
    "durandal": { x: 50, y: 55, scale: 1.3 },
    "groundzero": { x: 50, y: 60, scale: 1.2 },
    ...
    // Deal Defaults
    "blizzard": { x: 50, y: 70, scale: 1.2 },
    "cannonbaguka": { x: 50, y: 90, scale: 1.0 },
    "cosmos": { x: 50, y: 60, scale: 1.2 },
    "crossthesticks": { x: 50, y: 50, scale: 1.0 },
    "darkimpaile": { x: 40, y: 65, scale: 1.0 },
    "darkspear": { x: 50, y: 90, scale: 1.0 },
    "deadlycharge": { x: 60, y: 60, scale: 1.5 },
    "demonimpact": { x: 45, y: 80, scale: 1.2 },
    "endlesspain": { x: 45, y: 75, scale: 1.0 },
    "fallingjustice": { x: 50, y: 65, scale: 1.0 },
    "foreverstervingbeast": { x: 50, y: 70, scale: 1.0 },
    "fourseason": { x: 50, y: 50, scale: 1.0 },
    "gambit": { x: 65, y: 44, scale: 1.0 },
    "genesis": { x: 46, y: 65, scale: 1.0 },
    "gumgobong": { x: 45, y: 80, scale: 1.2 },
    "karmapury": { x: 60, y: 70, scale: 1.5 },
    "laststanding": { x: 40, y: 85, scale: 1.3 },
    "legendaryspear": { x: 50, y: 50, scale: 1.0 },
    "limitbreak": { x: 50, y: 50, scale: 1.0 },
    "lineinfentry": { x: 30, y: 85, scale: 1.0 },
    "longrangetrueshoot": { x: 50, y: 80, scale: 1.0 },
    "loyalguard": { x: 46, y: 65, scale: 0.7 },
    "metalarmor": { x: 50, y: 80, scale: 1.3 },
    "mothership": { x: 50, y: 65, scale: 1.0 },
    "needlebat": { x: 50, y: 55, scale: 1.0 },
    "nightmare": { x: 50, y: 70, scale: 1.0 },
    "nova": { x: 50, y: 50, scale: 1.0 },
    "pachopung": { x: 50, y: 70, scale: 1.0 },
    "persilrade": { x: 50, y: 50, scale: 1.0 },
    "poisonregion": { x: 50, y: 85, scale: 1.0 },
    "primalrore": { x: 50, y: 74, scale: 1.0 },
    "purgerop": { x: 50, y: 70, scale: 1.2 },
    "robotlauncherRM7": { x: 45, y: 85, scale: 1.0 },
    "ruin": { x: 50, y: 65, scale: 1.2 },
    "smight": { x: 50, y: 65, scale: 1.2 },
    "soulpanetrition": { x: 50, y: 70, scale: 1.0 },
    "superfistinrage": { x: 50, y: 80, scale: 1.1 },
    "swordillustion": { x: 60, y: 75, scale: 1.5 },
    "takedown": { x: 50, y: 60, scale: 1.3 },
    "thunderbreak": { x: 76, y: 65, scale: 1.3 },
    "thunderpower": { x: 50, y: 70, scale: 1.2 },
    "thunderspear": { x: 70, y: 60, scale: 1.0 },
    "ultimateblast": { x: 50, y: 70, scale: 1.5 },
    "ultimatesniping": { x: 110, y: 80, scale: 2.5 },
    "uncountablearrow": { x: 60, y: 70, scale: 1.0 },
    "wildvalcan": { x: 60, y: 80, scale: 1.3 },
